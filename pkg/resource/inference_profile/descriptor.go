...
const (
	FinalizerString = "finalizers.bedrock.services.k8s.aws/InferenceProfile"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("inferenceprofiles")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.InferenceProfile{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.InferenceProfile),
	}
}
