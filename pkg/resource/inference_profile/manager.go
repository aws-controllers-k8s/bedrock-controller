...
// +kubebuilder:rbac:groups=bedrock.services.k8s.aws,resources=inferenceprofiles,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=bedrock.services.k8s.aws,resources=inferenceprofiles/status,verbs=get;update;patch
